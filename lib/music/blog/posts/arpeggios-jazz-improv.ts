...
export const ARPEGGIOS_JAZZ_IMPROV: BlogPost = {
  slug: 'arpeggios-jazz-improv',
  title: 'Arpeggios: The Difference Between Noodling and Actually Playing the Changes',
  subtitle: 'How spelling out chord tones transforms random notes into a real jazz solo',
  ...
  content: [
    {
      type: 'p',
      text: 'There\'s a moment in every jazz musician\'s life that feels like putting on glasses for the first time. You\'ve been running scales over changes for months, maybe years, and your solos sound... fine. Competent. Like someone who knows where the notes are but doesn\'t really know what to say with them. Then one day, you start landing chord tones on the downbeats, and suddenly your lines have gravity. They pull toward something. They mean something. That\'s the arpeggio breakthrough, and once it happens, there\'s no going back.',
    },
    {
      type: 'h2',
      text: 'What "Playing the Changes" Actually Means',
    },
    {
      type: 'p',
    ...
    {
      type: 'h2',
      text: 'Charlie Parker and the Art of Spelling Chords at 300 BPM',
    },
    {
      type: 'p',
    ...
    {
      type: 'h2',
      text: 'The Scale Trap (And How Arpeggios Get You Out)',
    },
    {
      type: 'p',
    ...
    },
    {
      type: 'tip',
      label: 'Try This',
      text: 'Pick a ii-V-I in any key. Play the arpeggios of each chord in half notes: Dm7 (D-F-A-C), G7 (G-B-D-F), Cmaj7 (C-E-G-B). Now notice: the C in Dm7 resolves down a half step to B in G7, and the F in G7 resolves down to E in Cmaj7. Those guide tone movements are the skeleton of bebop.',
    },
    {
      type: 'h2',
      text: 'Beyond the Basics: Mixing Arpeggios and Scales',
    },
    {
      type: 'p',
      text: 'Nobody plays pure arpeggios in a solo (well, almost nobody). The magic happens when you combine them with scale material, chromatic approach notes, and rhythmic variation. A classic bebop move is to approach a chord tone from a half step below, giving the line a sense of propulsion. Another is to play an arpeggio ascending, then a scale fragment descending, creating that characteristic bebop contour of leaps followed by stepwise motion.',
    },
    {
      type: 'p',
    ...
    {
      type: 'pullquote',
      text: 'Master your instrument, master the music, and then forget all that and just play.',
      attribution: 'Charlie Parker',
    },
    {
      type: 'h2',
      text: 'The Before and After',
    },
    {
      type: 'p',
    ...
    {
      type: 'p',
      text: 'The work isn\'t glamorous. It\'s sitting with a metronome and playing Dm7-G7-Cmaj7 arpeggios until you can do it in your sleep, then doing it in all twelve keys, then doing it on actual tunes. But the payoff is enormous. One day you\'ll be soloing and you\'ll realize you\'re not thinking about scales anymore. You\'re hearing the chords, and your fingers are following. That\'s the moment everything changes.',
    },
  ],
  relatedStandards: ['confirmation', 'donna-lee'],
  furtherReading: [
    {
      title: 'Charlie Parker\'s Secrets to Confirmation and Bebop',
      url: 'https://www.jazzadvice.com/lessons/charlie-parkers-secrets-to-confirmation/',
    ...
    {
      title: 'How To Play Bebop',
      url: 'https://www.learn2playjazz.com/improvisation-techniques/how-to-play-bebop',
      description: 'A practical guide to the arpeggio-based approach that defines the bebop style.',
    },
  ],
};
