...
export const MINOR_PENTATONIC_JAZZ_IMPROV: BlogPost = {
  slug: 'minor-pentatonic-jazz-improv',
  title: 'The Minor Pentatonic Scale: Your First Jazz Improv Weapon',
  subtitle: 'Five notes. That\'s it. And they\'ll take you surprisingly far',
  ...
  content: [
    ...
    {
      type: 'h2',
      text: 'Five Notes, Zero Bad Choices',
    },
    {
      type: 'p',
    ...
    {
      type: 'h2',
      text: 'Blue Bossa: Two Pentatonics, One Tune',
    },
    {
      type: 'p',
  ...
  furtherReading: [
    {
      title: '9 Ways to Supercharge Your Improv With the Pentatonic Scale - Learn Jazz Standards',
      url: 'https://www.learnjazzstandards.com/blog/learning-jazz/jazz-theory/9-uses-for-pentatonic-scale/',
      description: 'Advanced pentatonic concepts for when you\'re ready to go beyond the basics.',
    },
    {
      title: 'How to Use the Pentatonic Scale in Jazz Piano Improvisation - Jazz Tutorial',
      url: 'https://jazztutorial.com/articles/how-to-use-the-pentatonic-scale-in-your-jazz-piano-improvisation',
      description: 'Piano-specific pentatonic techniques with audio examples.',
    },
    {
      title: 'Pentatonic scale - Wikipedia',
      url: 'https://en.wikipedia.org/wiki/Pentatonic_scale',
      description: 'The theory and global history of the five-note scale.',
    },
  ],
};
