...
export const KEEPING_THE_FORM_JAZZ: BlogPost = {
  slug: 'keeping-the-form-jazz',
  title: 'How to Never Get Lost in a Jazz Solo Again',
  subtitle: 'Practical strategies for keeping track of where you are, even when everything goes sideways',
  publishedAt: '2026-03-05',
  readingTime: 5,
  category: 'improv',
  tags: ['jazz form', 'soloing', 'AABA', 'keeping time', 'jazz standards', 'beginner jazz'],
  excerpt:
