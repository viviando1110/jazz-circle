...
export const HOW_JAZZ_JAM_SESSIONS_WORK: BlogPost = {
  slug: 'how-jazz-jam-sessions-work',
  title: 'Your First Jazz Jam Session: What to Expect and How Not to Panic',
  subtitle: 'The unwritten rules, the default arrangement, and how to survive your first night at the jam',
  publishedAt: '2026-03-05',
  readingTime: 5,
  category: 'ensemble',
  tags: ['jam session', 'jazz etiquette', 'head', 'solos', 'vamp', 'jazz standards'],
  excerpt:
  ...
  content: [
    {
      type: 'p',
      text: 'You\'ve been woodshedding in your practice room for months. Your Dorian scales are clean, your ii-V-I licks are coming together, and you can play "Autumn Leaves" with your eyes closed. So you decide it\'s time for the real test: the Monday night jam session at the local jazz club. You walk in, sign the list, sit down with your horn case in your lap, and immediately realize you have no idea what\'s about to happen. Someone says "let\'s play one" and everyone seems to know exactly what to do except you. Welcome to your first jam session.',
    },
    {
      type: 'h2',
      text: 'The Vocabulary You Need Before You Walk In',
    },
    {
      type: 'p',
      text: 'Jazz musicians throw around specific terms that mean very specific things, and you\'ll hear all of them in the first five minutes of a jam session. Getting familiar with these beforehand will save you from that deer-in-headlights moment when the piano player says "let\'s vamp on the last four and tag it."',
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'h2',
      text: 'The Default Arrangement (The One Nobody Explains)',
    },
    {
      type: 'p',
    ...
    {
      type: 'tip',
      label: 'How Long Should Your Solo Be?',
      text: 'At a jam session, keep your solos to two or three choruses. There are six people waiting to play, and a tune that goes on for twenty minutes because everyone took seven choruses is no fun for anyone. Short, focused solos are always more welcome than long, wandering ones.',
    },
    {
      type: 'h2',
      text: 'Choosing the Tune',
    },
    {
      type: 'p',
    ...
    },
    {
      ...
      slug: 'autumn-leaves',
      label: 'Autumn Leaves',
      note: 'One of the most commonly called tunes at jam sessions. If you know one jazz standard, make it this one.',
    },
    {
      type: 'standard-ref',
      slug: 'summertime',
    ...
    {
      type: 'h2',
      text: 'Endings: The Part Nobody Talks About',
    },
    {
      type: 'p',
  ...
  furtherReading: [
    ...
    {
      title: 'Jazz Jam Session Etiquette',
      url: 'https://wilktone.com/?p=300',
