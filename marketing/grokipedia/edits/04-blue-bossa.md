# Grokipedia Edit — Blue Bossa (Kenny Dorham)

**Priority:** 🔴 High — Form label contradicts the chord listing in same article

**Article URL:** https://grokipedia.com/page/Blue_Bossa

**Status:** [ ] Submitted / [ ] Approved / [ ] Denied

---

## Edit #1 — Form Label Error (Internal Contradiction)

### How to Find the Text

Use Ctrl+F / Cmd+F and search for: `AABA` or `32-bar`
Look for the educational or theory section describing the form.
...
This is the strongest "internal contradiction" case — we don't need to
cite any external source, just point to the inconsistency within the
article itself. Grokipedia's review AI should be able to verify this
by simply reading the article's own chord listing (16 bars) vs. form
claim (32-bar AABA).
